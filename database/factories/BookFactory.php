...
class BookFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'front_image' => 'books/'.$this->faker->image('public/storage/images/books', 640, 480, null,false),
            'back_image' => 'books/'.$this->faker->image('public/storage/images/books', 640, 480, null,false),
